...
//        CGSize expectedSizeTitle = [title sizeWithFont:titleLabel.font constrainedToSize:maxSizeTitle lineBreakMode:titleLabel.lineBreakMode];
        ...
        CGRect  expectedSizeTitle1 = [title boundingRectWithSize:maxSizeTitle
                                                         options:opts
                                                      attributes:@{ NSFontAttributeName:titleLabel.font, NSParagraphStyleAttributeName : style }
                                                         context:nil];
        CGSize expectedSizeTitle = expectedSizeTitle1.size;
...
//        CGSize expectedSizeMessage = [message sizeWithFont:messageLabel.font constrainedToSize:maxSizeMessage lineBreakMode:messageLabel.lineBreakMode];
        ...
        CGRect  expectedSizeTitle1 = [message boundingRectWithSize:maxSizeMessage
                                                         options:opts
                                                      attributes:@{ NSFontAttributeName:messageLabel.font, NSParagraphStyleAttributeName : style }
                                                         context:nil];
        CGSize expectedSizeMessage = expectedSizeTitle1.size;
